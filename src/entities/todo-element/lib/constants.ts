...
export const exampleTodo = [
  ...
  { isEnd: false, text: 'Бросить пить кофе', date: formatDate(getRandomDate()), priority: 2 as const },
  { isEnd: true, text: 'Погладить кота', date: formatDate(getRandomDate()), priority: 4 as const },
